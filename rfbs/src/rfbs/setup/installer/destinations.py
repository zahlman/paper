...
from ._compat.typing import TYPE_CHECKING
from .records import Hash, RecordEntry
...
if TYPE_CHECKING:
    ...
    from ._compat.typing import FSPath, Text
    from .scripts import LauncherKind, ScriptSection
